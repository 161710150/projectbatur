...
<script src="{{asset('assets/dist/sweetalert-dev.js')}}"></script>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{ asset ('assets/frontend/images/kuning.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Dunia Aksesoris</span>
    </a>
